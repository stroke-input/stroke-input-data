...
if __name__ == '__main__':
  ...
  print(
    f'{traditional_fraction:5.1%} of characters are traditional-only.'
  )
  
  simplified_fraction = simplified_character_count / character_count
  print(
    f'{simplified_fraction:5.1%} of characters are simplified-only.'
  )
  
  dual_fraction = 1 - traditional_fraction - simplified_fraction
  print(
    f'{dual_fraction:5.1%} of characters are dual.'
  )
